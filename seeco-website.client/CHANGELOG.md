...
- Create Angular project with ng: `ng new seeco-website.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`seeco-website.client.esproj`).
